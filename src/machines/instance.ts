...
export enum STATES {
    ...
    DEPLOYING = 'DEPLOYING',
    DEPLOYING_ERROR = 'DEPLOYING_ERROR',
    DEPLOYED = 'DEPLOYED',

    UNDEPLOYING = 'UNDEPLOY',
    UNDEPLOYING_ERROR = 'UNDEPLOYING_ERROR',
...
const TRANSITIONS = [
    ...
    {from: STATES.DEPLOYING, via: ACTIONS.ERROR, to: STATES.DEPLOYING_ERROR},
    ...
    // DEPLOYING_ERROR
    {from: STATES.DEPLOYING_ERROR, via: ACTIONS.CONTINUE, to: STATES.DEPLOYING},
    {from: STATES.DEPLOYING_ERROR, via: ACTIONS.UNDEPLOY, to: STATES.UNDEPLOYING},

    // UNDEPLOYING
    {from: STATES.UNDEPLOYING, via: ACTIONS.SUCCESS, to: STATES.RESOLVED},
    {from: STATES.UNDEPLOYING, via: ACTIONS.ERROR, to: STATES.UNDEPLOYING_ERROR},

    // UNDEPLOYING_ERROR
    {from: STATES.UNDEPLOYING_ERROR, via: ACTIONS.UNDEPLOY, to: STATES.UNDEPLOYING},
    ...
    // SWAPPING_ERROR
    {from: STATES.SWAPPING_ERROR, via: ACTIONS.SWAP, to: STATES.SWAPPING},
...
/**
 * NOOPs which are allowed in any state
 */
