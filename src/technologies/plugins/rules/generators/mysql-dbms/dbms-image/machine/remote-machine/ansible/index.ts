...
const generator: ImplementationGenerator = {
    ...
    weight: 1,
    reason: 'The MySQL DBMS is hosted on a remote machine. Ansible is specialized for installing software components, while Terraform discourages from being used to manage such scenarios.',
