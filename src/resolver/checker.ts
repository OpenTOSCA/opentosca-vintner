...
export default class Checker {
    ...
    run() {
        ...
        if (this.graph.options.consistency.relationSourceConsistencyCheck) {
        ...
        if (this.graph.options.consistency.relationTargetConsistencyCheck) {
            for (const relation of relations) {
        ...
        if (this.graph.options.consistency.ambiguousHostingConsistencyCheck) {
        ...
        if (this.graph.options.consistency.expectedHostingConsistencyCheck) {
            for (const node of nodes) {
                const relations = node.outgoing.filter(
        ...
        if (this.graph.options.consistency.missingArtifactParentConsistencyCheck) {
        ...
        if (this.graph.options.consistency.ambiguousArtifactConsistencyCheck) {
            for (const node of nodes) {
                const names = new Set()
                for (const artifact of artifacts) {
        ...
        if (this.graph.options.consistency.missingPropertyParentConsistencyCheck) {
        ...
        if (this.graph.options.consistency.ambiguousPropertyConsistencyCheck) {
            for (const node of nodes) {
                const names = new Set()
        ...
        if (this.graph.options.consistency.missingTypeContainerConsistencyCheck) {
        ...
        if (this.graph.options.consistency.ambiguousTypeConsistencyCheck) {
            for (const node of nodes) {
                const names = new Set()
