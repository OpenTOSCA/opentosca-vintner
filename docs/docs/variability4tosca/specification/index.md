...
| persisent                     | false     | Boolean                                                                              | Configure if node is persisent, e.g., always consumed by an end user from the browser. This will prevent unexpected pruning by setting the pruning option to false.                      |
