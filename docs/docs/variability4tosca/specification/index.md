...
| has_present_target          | Policy: String &#124; Number                                                        | Boolean | Returns if any target of the given policy is present.                                                                                                                            |
| has_present_member          | Group: String                                                                       | Boolean | Returns if any member of the given group is present.                                                                                                                             |
