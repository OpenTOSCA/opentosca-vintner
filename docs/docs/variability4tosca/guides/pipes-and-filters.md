...
<figure markdown>
  ![Deployment Variant using Raspberry Pi](../../assets/documents/pipes-and-filters/deployment-variant-pi.png){width="500"}
  <figcaption>Figure 1: Deployment Variant using Raspberry Pi</figcaption>
</figure>

<figure markdown>
  ![Deployment Variant using Virtual Machine](../../assets/documents/pipes-and-filters/deployment-variant-vm.png){width="500"}
