...
| get_source_presence        | Tuple(String, String) &#124; Tuple(String, Number) | Boolean | Returns if source node of relation is present.                                                          |
| get_target_presence        | Tuple(String, String) &#124; Tuple(String, Number) | Boolean | Returns if target node of relation is present.                                                          |
